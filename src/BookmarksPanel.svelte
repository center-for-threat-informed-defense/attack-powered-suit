<script>
    ...
    function exportAttackLayer() {
        ...
        exportColor = document.getElementById('defaultColor').value;
    ...
    function updateColorSelection() {
        // Toggle whether or not to change/export node colors
        let cb = document.getElementById("color-toggle");
...
<h3>
    <input
        type="checkbox"
        id="color-toggle"
        on:click={() => updateColorSelection()}
    >
    <label for="color-toggle">Edit Color</label>
</h3>
